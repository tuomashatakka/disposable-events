(function webpackUniversalModuleDefinition(root, factory) {
   ...
   //Kikke li
		...
		exports["disposableEvents"] = factory();
   //Kikke li
	else
		root["disposableEvents"] = factory();
})(this, function() {
...
var Disposable = function () {
  (0, _createClass3.default)(Disposable, null, [{
    key: "isDisposable",
  ...
  function Disposable(disposalAction) {
    (0, _classCallCheck3.default)(this, Disposable);
  ...
  (0, _createClass3.default)(Disposable, [{
    key: "dispose",
    value: function dispose() {
      if (!this.disposed) {
        this.disposed = true;
        if (this.disposalAction) this.disposalAction();
...
var _Disposable2 = __webpack_require__("./src/Disposable.js");

var _Disposable3 = _interopRequireDefault(_Disposable2);

var _patch = __webpack_require__("./src/patch.js");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var missingArgumentError = function missingArgumentError(pre, name) {
  return pre + ' the listened event must be provided for the DisposableEvent by passing a `' + name + '` property upon calling its constructor';
};
var missingTypeError = missingArgumentError("The type of", "type");
var missingHandlerError = missingArgumentError("The handler for", "handler");

var DisposableEvent = function (_Disposable) {
  (0, _inherits3.default)(DisposableEvent, _Disposable);

  function DisposableEvent(_ref) {
    var type = _ref.type,
        handler = _ref.handler,
        target = _ref.target;
    (0, _classCallCheck3.default)(this, DisposableEvent);
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (DisposableEvent.__proto__ || (0, _getPrototypeOf2.default)(DisposableEvent)).call(this, unbind));

    if (!handler) throw new Error(missingHandlerError);

    if (!type) throw new Error(missingTypeError);

    _this.type = type || 'click';
    _this.target = target || document;
    _this.handler = function (e) {
      return handler(e);
    };

    _this.unbind = _this.unbind.bind(_this);
    _this.bind = _this.bind.bind(_this);
    _this.bind();

    // patchDetachCallback(this.target, this.unbind)
    return _this;
  }

  (0, _createClass3.default)(DisposableEvent, [{
    key: 'bind',
    value: function bind() {
      if (!this.disposed) this.target.addEventListener(this.type, this.handler);
    }
  }, {
    key: 'unbind',
...
exports.default = DisposableEvent;
...
var _Disposable = __webpack_require__("./src/Disposable.js");

var _Disposable2 = _interopRequireDefault(_Disposable);

var _DisposableEvent = __webpack_require__("./src/DisposableEvent.js");
...
function Event() {
  return new (Function.prototype.bind.apply(_DisposableEvent2.default, [null].concat(Array.prototype.slice.call(arguments))))();
}
//
// const exports = {
//   Disposable,
...
exports.patchCallback = undefined;
...
var patchCallback = exports.patchCallback = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(element, name) {
    for (var _len = arguments.length, callbacks = Array(_len > 2 ? _len - 2 : 0), _key = 2; _key < _len; _key++) {
      callbacks[_key - 2] = arguments[_key];
    }

    var originalCallback, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, callback, handler;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            originalCallback = element[name].bind(element);

            element.callbacks[name] = [];
            element[name] = function () {
              var _arguments = arguments;

              if (!element.callbacks[name].length) return originalCallback.apply(element, arguments);else return element.callbacks[name].forEach(function (fn) {
                return fn.apply(element, _arguments);
              });
            };
            _context.next = 26;
            break;
  ...
  return function patchCallback(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.patchDetachCallback = patchDetachCallback;

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function patchDetachCallback(element) {
  for (var _len2 = arguments.length, fn = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
    fn[_key2 - 1] = arguments[_key2];
  }

  patchCallback.apply(undefined, [element, 'remove'].concat(fn));
}
